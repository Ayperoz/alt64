...
export class TemplatesWhatsappController {
  ...
  @ApiResponse({ status: 400, description: 'Erro ao encontrar os templates com o Whatsapp Oficial' })
  @ApiResponse({ status: 200, description: 'Retorna os registros de templates do Whatsapp Oficial' })
