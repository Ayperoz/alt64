...
export class WebhookController {
  ...
  @ApiResponse({ status: 400, description: 'Retorna o erro para quem esta chamando' })
  @ApiResponse({ status: 200, description: 'Retorna somente um true caso tenha sucesso' })
