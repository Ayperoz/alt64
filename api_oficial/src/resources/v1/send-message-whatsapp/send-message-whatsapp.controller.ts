import { Controller, Post, Body, Param, UseInterceptors, UploadedFile, Request } from '@nestjs/common';
...
export class SendMessageWhatsappController {
  ...
  @ApiResponse({ status: 400, description: 'Erro ao salvar a mensagem para enviar' })
  @ApiResponse({ status: 200, description: 'Retorna o registro salvo no banco para enviar a mensagem do whats' })
