...
import { IMessageReceived, IReceivedWhatsppOficial, IReceivedWhatsppOficialRead } from 'src/@core/interfaces/IWebsocket.interface';
import { CompaniesService } from 'src/resources/v1/companies/companies.service';
import { IWebhookWhatsApp } from 'src/resources/v1/webhook/interfaces/IWebhookWhatsApp.inteface';
