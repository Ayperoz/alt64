...
export async function savedFile(file: Express.Multer.File, pathFile: string, fileName: string): Promise<string> {
    ...
    if (!!existsSync(filePath)) throw new Error('Já existe um arquivo com este nome');
