      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Body: </b> {"{"} <br></br>
             "number": "5491122334455" <br></br>
             "body": "Mensaje" <br></br> 
             "userId": ID usuário "" <br></br>
             "queueId": ID Fila ""<br></br>
             "sendSignature": Asignar mensaje - true/false <br></br>
             "closeTicket": Cerrar ticket - true/false<br></br>
             {"}"} 
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
            <b>Headers: </b> Authorization Bearer (token cadastrado) y Content-Type (multipart/form-data) <br />
            <b>FormData: </b> <br />
            <ul>
              <li>
                <b>number: </b> 5491122334455
              </li>
              <li>
                <b>body:</b> Mensaje
              </li>
              ...
              <li>
                <b>sendSignature:</b> Asignar mensaje true/false
              </li>
              <li>
