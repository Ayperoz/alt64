      ...
      messagesAPI: {
        ...
        API: {
          ...
          instructions: {
            ...
            comments1:
              "Antes de enviar mensajes, es necesario registrar el token vinculado a la conexión que enviará los mensajes. Para registrarse, acceda al menú 'Conexiones', haga clic en el botón de edición de la conexión e inserte el token en el campo correspondiente.",
            comments2:
      ...
      settings: {
        ...
        settings: {
          ...
          options: {
            ...
            creationCompanyUser: "Creación de Compania/Usuario",
