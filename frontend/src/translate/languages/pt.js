    ...
    translations: {
      ...
      userModal: {
        ...
        form: {
          ...
          allowRealTime: "Ver Panel de Asistencia",
      ...
      messagesAPI: {
        ...
        API: {
          ...
          instructions: {
            ...
            comments1:
              "Antes de enviar mensagens, é necessário o cadastro do token vinculado à conexão que enviará as mensagens. <br />Para realizar o cadastro acesse o menu 'Conexiones', clique no botão editar da conexão e insira o token no devido campo.",
            comments2:
      ...
      settings: {
        ...
        settings: {
          ...
          customMessages: {
            sendQueuePositionMessage: "mensaje de posición de la fila",
